...
export const idAbStartSearchPage = "elem_" + generateId(15);
export const idAbRangeSearchPage = "elem_" + generateId(15);
export const idAbOnlyOnePage = "elem_" + generateId(15);
export const idAbOnlyRangePage = "elem_" + generateId(15);
